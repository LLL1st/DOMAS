...
<div>
  <el-dialog
    ...
    <el-form size="mini" :model="inputForm" v-loading="loading" :class="method==='view'?'readonly':''" :disabled="method==='view'" :rules="dataRule" ref="inputForm" @keyup.enter.native="doSubmit()"
          ...
          <el-form-item label="多语言编码" prop="code">
            <el-input maxlength="50" v-model="inputForm.code" :placeholder="typeList[inputForm.type] + '多语言编码'"></el-input>
          </el-form-item>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button size="mini" v-if="method != 'view'" type="primary" @click="doSubmit()" v-noMoreClick>确定</el-button>
    </span>
  </el-dialog>
