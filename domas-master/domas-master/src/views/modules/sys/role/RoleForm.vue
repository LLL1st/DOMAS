<template>
  <el-dialog
    ...
    <el-form size="mini" :model="inputForm" status-icon :rules="dataRule" v-loading="loading" ref="inputForm" @keyup.enter.native="inputFormSubmit()"
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button size="mini" type="primary" @click="inputFormSubmit()" v-noMoreClick>确定</el-button>
    </span>
  </el-dialog>
</template>
