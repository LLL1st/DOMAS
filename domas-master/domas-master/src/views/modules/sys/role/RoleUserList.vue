<template>
    <div style="padding:10px">
        <el-form size="mini" :inline="true" v-show="isSearchCollapse" class="query-form" ref="searchForm" :model="searchForm" @keyup.enter.native="refreshList()" @submit.native.prevent>
        ...
        <el-row>
          <el-button v-if="hasPermission('sys:role:assign')" type="primary" size="mini" icon="el-icon-plus" @click="add()">添加用户</el-button>
        ...
        <el-table
          ...
          <el-table-column
            ...
            label="操作">
            <template slot-scope="scope">
              <el-button v-if="hasPermission('sys:role:assign')" type="text" size="mini" @click="del(scope.row.id)">
                移除
              </el-button>
            </template>
          </el-table-column>
