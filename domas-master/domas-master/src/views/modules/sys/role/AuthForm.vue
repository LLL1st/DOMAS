<template>
  <el-dialog
    ...
    <el-form size="mini" class="auth" :model="inputForm" status-icon v-loading="loading" ref="inputForm" @keyup.enter.native="inputFormSubmit()"
     ...
     <span slot="footer" class="dialog-footer">
      <el-button type="primary" icon="el-icon-check" size="mini" plain @click="inputFormSubmit()" v-noMoreClick>保存</el-button>
    </span>
  </el-dialog>
</template>
