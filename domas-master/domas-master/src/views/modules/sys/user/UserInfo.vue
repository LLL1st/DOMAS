    ...
    <el-row>
      <el-col :span="6">
          ...
          <el-upload
            ...
            <img v-if="photo" :src="photo" class="avatar" style="width:200px">
      ...
      <el-col :span="18">
        <el-tabs tab-position="top">
          <el-tab-pane label="基本信息">
            ...
            <el-form size="mini" :model="generalForm" ref="generalForm" label-width="100px">
              ...
              <el-form-item>
                <el-button size="mini" type="primary" @click="submitGeneralForm()">保存</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="联系方式">
            <h3 style="margin-left:40px">联系方式</h3>
            <el-form size="mini" :model="concatForm" ref="concatForm" label-width="100px">
              ...
              <el-form-item>
                <el-button  size="mini" type="primary" @click="submitConcatForm()">保存</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          ...
          <el-tab-pane label="修改密码">
            ...
            <el-form size="mini" :model="pwdForm" ref="pwdForm" label-width="100px">
              ...
              <el-form-item>
                <el-button size="mini" type="primary" @click="submitPwdForm()">保存</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
