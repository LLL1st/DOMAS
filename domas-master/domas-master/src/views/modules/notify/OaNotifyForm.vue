...
<div>
  <el-dialog
    ...
    <el-form size="mini" :model="inputForm" ref="inputForm" v-loading="loading" :class="method==='view' || method === 'read'?'readonly':''" :disabled="method==='view' || method === 'read'" @keyup.enter.native="doSubmit()"
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button size="mini" type="primary" v-if="method != 'view' && method != 'read'" @click="doSubmit()" v-noMoreClick>确定</el-button>
    </span>
  </el-dialog>
</div>
</template>
