<template>
  <el-dialog
    ...
    <el-form size="mini" :model="inputForm" ref="inputForm" @keyup.enter.native="doSubmit()"
             label-width="120px"
        ...
        <el-col :span="12">
         ...
         <el-col :span="12">
            <el-form-item label="数据库密码" prop="password" :rules="[{required: true, message:'数据库密码名不能为空', trigger:'blur'}]">
              <el-input v-model="inputForm.password" maxlength="50" placeholder="" type="password"></el-input>
            </el-form-item>
        </el-col>
    </el-row>
    ...
    <span slot="footer"  class="dialog-footer">
      <el-button size="mini" v-if="method != 'view'" type="primary" @click="testDbLink()">测试连接</el-button>
      <el-button size="mini" v-if="method != 'view'" @click="doSubmit()" v-noMoreClick>确定</el-button>
