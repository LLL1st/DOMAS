...
<div>
  <el-dialog
    ...
    <el-form size="mini" :model="inputForm" ref="inputForm" v-loading="loading" :class="method==='view'?'readonly':''" :disabled="method==='view'" @keyup.enter.native="doSubmit()"
    ...
    <span slot="footer" class="dialog-footer">
       <el-button type="danger" size="mini" v-if="method === 'edit'"  @click="del">删除</el-button>
