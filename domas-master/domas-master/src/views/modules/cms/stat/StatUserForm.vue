      ...
      <el-row  :gutter="15">
        <el-col :span="12">
            <el-form-item label="年龄" prop="age"
              ...
              <el-input v-model="inputForm.age" placeholder="请填写年龄"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      init (method, id) {
        ...
        this.$nextTick(() => {
          ...
          if (method === 'edit' || method === 'view') { // 修改或者查看
            this.loading = true
            this.$http({
              url: `/cms/stat/statUser/queryById?id=${this.inputForm.id}`,
              method: 'get'
            }).then(({data}) => {
              this.inputForm = this.recover(this.inputForm, data.statUser)
              this.loading = false
            })
          }
        })
