...
export function t2 (code) {
  let language = store.state.common.language
  return store.state.common.languageMap[code + '_' + language] || store.state.common.languageMap[code + '_' + language]
}
export default {escapeHTML, hashCode, unescapeHTML, handleImageAdded, download, recover, recoverNotNull, hasPermission, treeDataTranslate, printLogo, deepClone, validatenull, t2}
